export function DentalAILogo({ className = "h-8 w-8" }: { className?: string }) {
  return (
    <svg 
      viewBox="0 0 100 100" 
      fill="none" 
    ...
    >
      ...
      {/* AI connecting lines */}
      <line x1="36" y1="45" x2="40" y2="52" stroke="#60A5FA" strokeWidth="1" opacity="0.5" />
      <line x1="64" y1="45" x2="60" y2="52" stroke="#60A5FA" strokeWidth="1" opacity="0.5" />
    </svg>
  );
}

export function DentalAILogoBlue({ className = "h-8 w-8" }: { className?: string }) {
  return (
    <svg 
      viewBox="0 0 100 100" 
      fill="none" 

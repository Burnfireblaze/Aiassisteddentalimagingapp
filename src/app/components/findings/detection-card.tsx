        ...
        <div className="space-y-4">
          ...
          <div className="flex items-start justify-between gap-4">
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 mb-2">
                <h3 className="text-lg font-semibold text-gray-900">{finding.condition}</h3>
                <Badge 
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <p className="text-sm font-semibold text-gray-900">{finding.modality}</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-2 p-3 bg-gray-50 rounded-lg">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm text-gray-900 mt-0.5">{finding.timeline}</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-2 p-3 bg-blue-50 rounded-lg">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm text-blue-900 mt-0.5">{finding.action}</p>
            </div>
          </div>

  ...
  const features = [
    {
      ...
      description: 'Advanced AI detection of dental conditions with high accuracy'
    },
    {
      icon: Users,
      title: 'Multi-Role Access',
      description: 'Separate interfaces for doctors, patients, and administrators'
    },
    {
      icon: FileText,
      title: 'Clinical Reports',
      description: 'Professional PDF-ready reports with AI findings and recommendations'
    },
    {
      icon: MessageSquare,
      title: 'AI Assistant',
      description: 'Chat with AI for clinical insights and treatment recommendations'
    },
    {
      icon: Share2,
      title: 'Secure Sharing',
      description: 'Share records securely with patients and other healthcare providers'
    }
  ];
        ...
        <div className="relative z-10 flex flex-col">
          ...
          <div className="flex items-center space-x-3 mb-12">
            ...
            <div>
              ...
              <p className="text-blue-100 text-sm">Clinical Intelligence Platform</p>
            </div>
          </div>
          ...
          <div className="mb-12">
            ...
            <p className="text-blue-100 text-lg xl:text-xl">
              Comprehensive dental imaging analysis platform for modern healthcare professionals
            </p>
          </div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 sm:p-10">
            ...
            <div className="hidden lg:block mb-8">
              ...
              <p className="text-gray-600">Sign in to access your clinical dashboard</p>
            </div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-semibold text-blue-900 text-sm mb-2">Demo Access</h4>
                  <p className="text-xs text-blue-800 mb-2">Enter any credentials to explore the platform</p>
